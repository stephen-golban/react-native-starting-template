...
export const sharePause = (_nextAnimation: any, paused: SharedValue<boolean>) => {
  'worklet';

  return defineAnimation(_nextAnimation, () => {
    'worklet';
    const nextAnimation: any = typeof _nextAnimation === 'function' ? _nextAnimation() : _nextAnimation;
    ...
    const onStart = (state: any, value: AnimatableValue, now: number, previousState: any) => {

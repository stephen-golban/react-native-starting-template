 ...
 * Interpolate number
 */
export const useInterpolate = (progress: SharedValue<number>, input: number[], output: number[], type?: ExtrapolationType) =>
 ...
 */
export const useShareClamp = (value: SharedValue<number>, lowerValue: number, upperValue: number) => {
  'worklet';
 ...
 */
export function useInsideView<T extends Component>(wrapHeight: number | undefined = undefined): [React.RefObject<T>, SharedValue<boolean>] {
